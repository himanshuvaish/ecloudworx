...
export class MemStorage implements IStorage {
  ...
  private seedData() {
    ...
    categoriesData.forEach(cat => {
      const id = randomUUID();
      const category: Category = { ...cat, id, articleCount: 0 };
    ...
    const articlesData = [
      {
        ...
        categoryId: Array.from(this.categories.keys())[0],
      ...
      },
      {
        ...
        categoryId: Array.from(this.categories.keys())[1],
      ...
      },
      {
        ...
        categoryId: Array.from(this.categories.keys())[2],
      ...
      },
      {
        ...
        categoryId: Array.from(this.categories.keys())[3],
      ...
      },
      {
        ...
        categoryId: Array.from(this.categories.keys())[5],
