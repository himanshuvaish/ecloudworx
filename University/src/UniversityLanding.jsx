            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-6 border border-blue-200">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-blue-800">Multi-Cloud</h3>
                    <p className="text-sm text-blue-600">AWS • Azure • GCP</p>
                  </div>
                </div>
                <p className="text-sm text-blue-700">Manage resources across multiple cloud providers with unified controls.</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-6 border border-green-200">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-green-800">DevOps</h3>
                    <p className="text-sm text-green-600">CI/CD • Automation</p>
                  </div>
                </div>
                <p className="text-sm text-green-700">Streamline your development workflow with automated pipelines.</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-6 border border-purple-200">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-purple-600">IAM • Compliance</p>
                  </div>
                </div>
                <p className="text-sm text-purple-700">Secure your infrastructure with best practices and compliance tools.</p>
              </div>
            </div>
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    ...
                    <span className="text-sm text-green-600 font-medium">Chat →</span>
                  </div>
                </div>
              </div>
            </div>
